...
export default function Checkout() {
  ...
  // 🔥 FIX: Remove any auto-fill from login
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-slate-50 to-amber-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        {cartItems.length === 0 ? (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center py-20 bg-white rounded-3xl shadow-sm">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-5">
                ...
                <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="name" value={formData.customer_name} required className="mt-1.5 h-11 rounded-xl"
                    ...
                    <div>
                      ...
                      <Input id="email" type="email" value={formData.customer_email} required className="mt-1.5 h-11 rounded-xl"
                    ...
                    <div className="md:col-span-2">
                      ...
                      <Input id="phone" value={formData.customer_phone} required className="mt-1.5 h-11 rounded-xl"
                ...
                <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Textarea id="address" rows={2} className="mt-1.5 rounded-xl"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input id="city" value={formData.shipping_city} required className="mt-1.5 h-11 rounded-xl"
                      ...
                      <div>
                        ...
                        <Input id="zip" value={formData.shipping_zip} required className="mt-1.5 h-11 rounded-xl"
                ...
                <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                  ...
                  <RadioGroup value={formData.payment_method}
              ...
              <div className="lg:col-span-1">
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="bg-white rounded-2xl shadow-sm border border-slate-100 sticky top-24 overflow-hidden">
                      ...
                      {cartItems.map((item) => (
                        <div key={item.part_id} className="flex gap-3 p-3 bg-slate-50 rounded-xl">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm font-bold text-amber-600">${(item.price * item.quantity).toLocaleString()}</p>
                          </div>
